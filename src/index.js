...
//         })
//     })
//     .catch(error=> console.error('Error feetching or parsing films:', error));
// }
...
//     const descriptionEelement= document.getElementById('film-info');
...
//     descriptionEelement.textContent= movie.description;
...
//             const updatedTicketsSoold= movie.tickeets_sold + 1;
//             updateTicketsSold(movie.id, updateTicketsSold);
//         } else{
...
// function updateTicketsSold(movieId, updatedTikcetsSold){
//     fetch('http://localhost:3000/films/id',{
//         method: 'PATCH',
//         headers: {
//             'Contet-Type': 'application/jason'
//         },
//         body:JSON.stringify({
